...
$block_data = array(
    ...
    'routeColor'     => sanitize_hex_color( $attributes['routeColor'] ?? '#8a5a2b' ) ?: '#8a5a2b',
    'routeWidth'     => min( 20, max( 1, absint( $attributes['routeWidth'] ?? 4 ) ) ),
    'showRoutes'     => (bool) ( $attributes['showRoutes'] ?? true ),
